...
const TAMPILAN_STATUS = {
  ...
  [STATUS_KODE.PROSES_POTONG]: { label: 'PROSES POTONG', tone: 'gold' },
  [STATUS_KODE.INPUT_BUKU_POTONG]: { label: 'INPUT BUKU POTONG', tone: 'gold' },
  [STATUS_KODE.INPUT_NOTA]: { label: 'INPUT NOTA', tone: 'gold' },
  [STATUS_KODE.INPUT_HPP]: { label: 'INPUT HPP', tone: 'gold' },
  [STATUS_KODE.REVIEW_HPP]: { label: 'REVIEW HPP', tone: 'info' },
  ...
  [STATUS_KODE.SIAP_KIRIM]: { label: 'SIAP KIRIM', tone: 'gold' },
